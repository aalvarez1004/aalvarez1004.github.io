...
let imageModelURL = "https://teachablemachine.withgoogle.com/models/bquPwLdKm/"; //persiana aula informatica
//let imageModelURL = "https://teachablemachine.withgoogle.com/models/oefvaA67m/"; //fondo blanco
//let imageModelURL = "https://teachablemachine.withgoogle.com/models/i0ACUHxdm/"; //pose
...
function preload() {
  ...
  //classifier = ml5.poseNetClassifier(imageModelURL + "model.json");
}
